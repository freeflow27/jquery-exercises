...
// //     let movie = $("form").eq(0).val()
// //     let rating = $("form").eq(1).val()
// //     $("<h1></h1>").text(`${movie}`, `${rating}`)
// //         .appendTo("body")
// // })

// $("form").on("submit", function (e) {
//         e.preventDefault()
//         let movie = $("movie-rating").eq(0).val()
//         let rating = $("movie-rating").eq(1).val()
//         //let movieData = (movie.value(), rating.value())
//         $("body").append("<h1>", movie, rating)
//         //$(`<h1>"$("movie-rating").eq(0).val()" "${rating}"</h1>`).appendTo("body")
